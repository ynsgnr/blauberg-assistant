...
@pytest.mark.parametrize(
    "sections,value,expected", [([Section.Template(2), Section.Template(1), ExpandingSection()], bytes(
        [0x0, 0x01, 0x0F, 0x02]),  [Section(0x1, 2), Section(0xF, 1), ExpandingSection().set_bytes(bytes([0x02]))]),
        ([Section.Template(1), ExpandingSection()], bytes(
            [0x01, 0x01, 0x0F, 0x03]),  [Section(0x1, 1), ExpandingSection().set_bytes(bytes([0x01, 0x0F, 0x03]))]),
        ([Section.Template(1), ExpandingSection(), Section.Template(1)], bytes(
            [0x01, 0x01, 0x0F, 0x03]),  [Section(0x1, 1), ExpandingSection().set_bytes(bytes([0x01, 0x0F, 0x03])), Section()])
    ]
)
...
@pytest.mark.parametrize(
    "sections,value,expected", [([Section.Template(2), DynamicSection()], bytes(
        [0x0, 0x01, 0x01, 0x02]),  [Section(0x1, 2), DynamicSection().set_bytes(bytes([0x02]))]),
        ([Section.Template(2), DynamicSection(), Section.Template(1), ], bytes(
            [0x0, 0x01, 0x02, 0x02, 0x03, 0x04]),  [Section(0x1, 2), DynamicSection().set_bytes(bytes([0x02, 0x03])), Section(0x4)]),
        ([DynamicSection(), Section.Template(1)], bytes(
            [0x03, 0x01, 0x02]),  [DynamicSection().set_bytes(bytes([0x01, 0x02, 0x0])), Section()])
    ]
)
