...
class DynamicSection(Section):
    ...
    def __init__(self, length_byte_size: int = 1,  trail_or_lead: Zeros = Zeros.TRAILING):
    ...
    def __str__(self) -> str:
        ...
        return "0x{0:0{1}X}".format(self.byte_size, self.length_byte_size*2) + "-"+"0x{0:0{1}X}".format(self.value, self.byte_size*2)
